    ...
    <body><!-- 페이지 내용 -->
        ...
        <main data-role="page" id="page3">
            <header data-role="header" data-position="fixedd" data-theme="b">
                ...
                <nav data-role="navbar">
                    <ul>
                        ...
                        <li><a href="./delete.php" class="ui-btn-active">삭제</a></li>
            ...
            <article data-role="content">
                <h3>영화 정보 삭제</h3>
                <form name="form2" method="POST" action="delete_result.php" data-ajax="false"> 
                    <div class="ui-body ui-body-a">
                        ...
                        <select name="genre" data-native-menu="false" data-mini="true" data-inline="true" id="genre">
                            ...
                            <option value="에니메이션">에니메이션</option>
